...
::#region init > Version
::
::Set-Variable -Option Constant VERSION ([Version]'25.12.14')
::
...
::    Set-Variable -Option Constant FileName $((Split-Path -Leaf 'https://github.com/ventoy/Ventoy/releases/download/v1.1.09/ventoy-1.1.09-windows.zip').Replace('-windows', ''))
::    Start-DownloadUnzipAndRun 'https://github.com/ventoy/Ventoy/releases/download/v1.1.09/ventoy-1.1.09-windows.zip' $FileName -Execute:$CHECKBOX_StartVentoy.Checked
::}
