Set-Variable -Option Constant Version ([Version]'23.9.26')
...
Set-Variable -Option Constant URL_SDIO     'https://www.glenn.delahoy.com/downloads/sdio/SDIO_1.12.16.757.zip'
