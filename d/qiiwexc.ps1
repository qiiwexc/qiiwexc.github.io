Set-Variable -Option Constant Version ([Version]'23.1.8')
...
Set-Variable -Option Constant URL_VENTOY   'https://github.com/ventoy/Ventoy/releases/download/v1.0.87/ventoy-1.0.87-windows.zip'
