Set-Variable -Option Constant Version ([Version]'24.12.31')
...
Set-Variable -Option Constant URL_WINDOWS_11 'https://w16.monkrus.ws/2024/01/windows-11-v23h2-rus-eng-28in1-hwid-act.html'
...
Set-Variable -Option Constant URL_SDIO     'https://www.glenn.delahoy.com/downloads/sdio/SDIO_1.13.6.773.zip'
