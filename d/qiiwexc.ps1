Set-Variable -Option Constant Version ([Version]'24.6.28')
...
Set-Variable -Option Constant URL_SDIO     'https://www.glenn.delahoy.com/downloads/sdio/SDIO_1.13.1.765.zip'
