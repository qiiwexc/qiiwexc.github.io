Set-Variable -Option Constant Version ([Version]'25.1.29')
...
Set-Variable -Option Constant URL_VENTOY   'https://github.com/ventoy/Ventoy/releases/download/v1.1.00/ventoy-1.1.00-windows.zip'
