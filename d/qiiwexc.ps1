Set-Variable -Option Constant Version ([Version]'23.4.28')
...
Set-Variable -Option Constant URL_RUFUS    'https://github.com/pbatard/rufus/releases/download/v4.0/rufus-4.0p.exe'
...
Set-Variable -Option Constant URL_SDIO     'https://www.glenn.delahoy.com/downloads/sdio/SDIO_1.12.11.751.zip'
