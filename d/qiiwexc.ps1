Set-Variable -Option Constant Version ([Version]'23.12.3')
...
Set-Variable -Option Constant URL_SDIO     'https://www.glenn.delahoy.com/downloads/sdio/SDIO_1.12.17.757.zip'
