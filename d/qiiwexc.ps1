Set-Variable -Option Constant Version ([Version]'25.4.10')
...
Set-Variable -Option Constant URL_SDIO     'https://www.glenn.delahoy.com/downloads/sdio/SDIO_1.15.1.813.zip'
