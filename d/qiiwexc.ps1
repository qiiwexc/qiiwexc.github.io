Set-Variable -Option Constant Version ([Version]'25.5.4')
...
Set-Variable -Option Constant URL_SDIO     'https://www.glenn.delahoy.com/downloads/sdio/SDIO_1.15.3.814.zip'
