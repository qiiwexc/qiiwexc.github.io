Set-Variable -Option Constant Version ([Version]'23.6.24')
...
Set-Variable -Option Constant URL_VENTOY   'https://github.com/ventoy/Ventoy/releases/download/v1.0.93/ventoy-1.0.93-windows.zip'
