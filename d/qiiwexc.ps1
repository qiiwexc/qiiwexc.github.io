Set-Variable -Option Constant Version ([Version]'25.6.12')
...
Set-Variable -Option Constant URL_RUFUS    'https://github.com/pbatard/rufus/releases/download/v4.8/rufus-4.8p.exe'
...
Set-Variable -Option Constant URL_SDIO     'https://www.glenn.delahoy.com/downloads/sdio/SDIO_1.15.4.815.zip'
