Set-Variable -Option Constant Version ([Version]'22.11.3')
...
Set-Variable -Option Constant URL_VENTOY   'https://github.com/ventoy/Ventoy/releases/download/v1.0.81/ventoy-1.0.81-windows.zip'
