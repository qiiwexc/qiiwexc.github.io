Set-Variable -Option Constant Version ([Version]'23.9.15')
...
Set-Variable -Option Constant URL_SDIO     'https://www.glenn.delahoy.com/downloads/sdio/SDIO_1.12.15.756.zip'
