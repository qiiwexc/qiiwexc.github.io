Set-Variable -Option Constant Version ([Version]'25.5.20')
...
Set-Variable -Option Constant URL_RUFUS    'https://github.com/pbatard/rufus/releases/download/v4.7/rufus-4.7p.exe'
