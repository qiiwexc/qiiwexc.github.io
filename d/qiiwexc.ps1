Set-Variable -Option Constant Version ([Version]'24.9.16')
...
Set-Variable -Option Constant URL_SDIO     'https://www.glenn.delahoy.com/downloads/sdio/SDIO_1.13.4.771.zip'
