Set-Variable -Option Constant Version ([Version]'24.9.10')
...
Set-Variable -Option Constant URL_SDIO     'https://www.glenn.delahoy.com/downloads/sdio/SDIO_1.13.3.767.zip'
