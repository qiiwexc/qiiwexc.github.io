Set-Variable -Option Constant Version ([Version]'23.3.15')
...
Set-Variable -Option Constant URL_VENTOY   'https://github.com/ventoy/Ventoy/releases/download/v1.0.89/ventoy-1.0.89-windows.zip'
