Set-Variable -Option Constant Version ([Version]'22.11.22')
...
Set-Variable -Option Constant URL_VENTOY   'https://github.com/ventoy/Ventoy/releases/download/v1.0.82/ventoy-1.0.82-windows.zip'
