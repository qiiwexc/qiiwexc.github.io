Set-Variable -Option Constant Version ([Version]'24.11.17')
...
Set-Variable -Option Constant URL_SDIO     'https://www.glenn.delahoy.com/downloads/sdio/SDIO_1.13.5.772.zip'
