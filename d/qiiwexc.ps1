Set-Variable -Option Constant Version ([Version]'24.1.28')
...
Set-Variable -Option Constant URL_SDIO     'https://www.glenn.delahoy.com/downloads/sdio/SDIO_1.12.19.760.zip'
