BeforeAll {
    ...
    Set-Variable -Option Constant TestVolumeCache1 ([PSObject]@{ PsPath = 'TEST_VOLUME_CACHE_1' })
    Set-Variable -Option Constant TestVolumeCache2 ([PSObject]@{ PsPath = 'TEST_VOLUME_CACHE_2' })
}
