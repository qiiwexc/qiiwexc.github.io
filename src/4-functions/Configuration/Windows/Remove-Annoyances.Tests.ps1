BeforeAll {
    ...
    Set-Variable -Option Constant CONFIG_ANNOYANCES ([String]'TEST_CONFIG_ANNOYANCES')

    Set-Variable -Option Constant TestAppName ([String]'Remove Windows Annoyances')
...
Describe 'Remove-Annoyances' {
    ...
    It 'Should remove Windows annoyances' {
        Remove-Annoyances $TestAppName
